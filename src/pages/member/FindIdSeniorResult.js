// src/pages/member/FindIdSeniorResult.js
import React, { useContext, useState, useEffect } from 'react';
import { useNavigate, useParams, useLocation } from 'react-router-dom';
import { AuthContext } from '../../AuthProvider';
import { apiSpringBoot } from '../../utils/axios';
import styles from './FindIdSeniorResult.module.css';
import SeniorFooter from '../../components/common/SeniorFooter';

const FindIdSeniorResult = () => {
  // 조회된 아이디 저장관리 상태변수
  ...
  const handleMovePwdFind = () => {
    navigate('/memRouter/findpwdsenior');
  };
        ...
        {result === 'success' ? (
          <div className={styles.buttonDiv}>
            <button
              ...
              onClick={() => navigate('/memRouter/loginsenior')}
            >
              로그인 하기
            </button>
...
export default FindIdSeniorResult;
